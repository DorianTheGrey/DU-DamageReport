### This script is no longer supported as I am not agreeing to the way NovaQuark (the developer/publisher of Dual Universe) is handling their customer support as well as their communication to their community. I leave the script for others to download, use, alter - please do not contact me for support any longer.
